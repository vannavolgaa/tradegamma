...
def save_backtest(data:BacktestOutput) -> None: 
    path = 'data/backtest/'+str(datetime.now().timestamp())+'_backtest.pkl'
...
class VolatilityTraderBlacktest: 
    ...
    def portfolio_report(self, portfolio:Portfolio) -> dict: 
        ...
        return {
            'time' : ref_date, 
            'usd_value' : portfolio.get_usd_value(), 
            ...
            'usd_realised': portfolio.get_usd_realised_pnl(), 
